...
return (
			...
			<Box sx={{ background:'#FFF',position:'relative',textAlign:'center'}} >
				...
				<Stack direction="row" alignItems="center" justifyContent="center" css={animatedItem} sx={{minHeight:'100vh',p:4,
...
filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr="#9308ff",endColorstr="#0cdeff",GradientType=1)'
          ...
          alt="BareRock"
        />
				<Typography variant="body2" sx={{mt:{xs:3,sm:4},textAlign:'center',color:'#FFF',fontWeight:800,fontSize:{xs:19,sm:25}}}>Good companies,{isMobile?<Divider sx={{borderColor:'transparent'}} />:''} in good company®</Typography>

				<Box sx={{textAlign:'center',maxWidth:700,width:'100%',margin:'0 auto'}}>

					<Typography sx={{width:'100%',mt:{xs:2,sm:7},textAlign:'center',color:'#FFF',fontSize:{xs:13,sm:17}}}>We’re revolutionising PI Insurance for Financial Advisers and Planners. </Typography>


					<Typography variant="body2" sx={{width:'100%',mb:{xs:1,sm:3},mt:{xs:1,sm:3},textAlign:'center',color:'#FFF',fontSize:{xs:13,sm:17}}}>Want to be the first to know our developments?{!isMobile?<br />:''} Sign up below: </Typography>
